  ...
  const startBattleRoyale = async () => {
    ...
    try {
      ...
      window.location.assign(
        new URL(`/tournaments/${tournamentId}/ta/finals`, window.location.origin).toString(),
      );
    } catch (startError) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">{t('battleRoyalePhaseSummary')}</p>
        </div>
          ...
          {!isAdmin ? (
            ...
            <>
              ...
              <div className="flex items-center gap-3 border-b pb-3">
                ...
                <span className="ml-auto text-sm text-muted-foreground">{selectedPlayers.length}</span>
              </div>
