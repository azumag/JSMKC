    ...
    >
      ...
      {overlayPlayer1Name && (
        <div
          ...
          style={{ left: 93, top: 489, width: 230, height: 48, overflow: "hidden" }}
        >
          <span
      ...
      {overlayPlayer1NoCamera && (
        <img
          ...
          aria-hidden="true"
          className="pointer-events-none fixed"
          style={{ left: 37, top: 156, width: 356, height: 328 }}
        />
      )}
      ...
      {overlayPlayer2Name && (
        <div
          className="pointer-events-none fixed flex flex-col items-center justify-center"
          style={{ left: 93, top: 883, width: 230, height: 48, overflow: "hidden" }}
        >
          <span
            className="text-white font-bold text-[1.65rem] leading-none truncate w-full text-center"
            style={{ textShadow: "0 1px 4px rgba(0,0,0,0.9), 0 0 8px rgba(0,0,0,0.8)" }}
      ...
      {overlayPlayer2NoCamera && (
        <img
          ...
          aria-hidden="true"
          className="pointer-events-none fixed"
          style={{ left: 37, top: 551, width: 356, height: 328 }}
        />
      )}
    </div>
  );
