...
export default async function RootLayout({
  ...
  return (
    <html lang={locale} className={`${fontDisplay.variable} ${fontSans.variable} ${fontMono.variable}`}>
      <head />
      <body className={`font-sans antialiased${isOverlay ? ' overlay-mode' : ''}`}>
            ...
            {isOverlay ? (
              ...
              <>
                <div className="min-h-screen bg-background">
                    ...
                    <div className="container mx-auto px-5 sm:px-6">
                      <nav className="flex items-center justify-between gap-4 py-3 sm:py-4">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                          ...
                          <span className="hidden sm:block w-px h-6 bg-foreground/15 mx-1" aria-hidden="true" />
                          <LocaleSwitcher />
                          <AuthHeader />
                        </div>
                      </nav>
                  ...
                  <main className="container mx-auto px-5 sm:px-6 py-10">{children}</main>
                </div>
 ...
 */
function NavLink({ href, messageKey }: { href: string; messageKey: string }) {
  return (
    <Link
      href={href}
      prefetch={false}
