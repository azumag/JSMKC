...
// ============================================================
// Client Identification (re-exported from request-utils.ts)
// ============================================================

/**
 * Re-export client identification utilities from their canonical location.
 * These were previously duplicated here; now request-utils.ts is the single source.
 */
export { getClientIdentifier, getUserAgent, getServerSideIdentifier } from '@/lib/request-utils';
