 ...
 */
export const FINALS_SLOT_SEMANTICS: Record<string, readonly FinalsMatchSlots[]> = {
  ...
  // BC48="Winner of 27"(losers_sf idx0). The app now uses this same P1/P2
  // ordering (#3036), so identity-based score resolution needs no reversal.
 ...
 */
export function getSlotSemantics(round: string, matchIndex: number, slotIndex: number): FinalsSlotSemantics | null {
