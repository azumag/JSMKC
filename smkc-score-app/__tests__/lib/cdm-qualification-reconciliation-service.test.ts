...
describe('CDM qualification reconciliation service', () => {
  ...
  it('atomically remaps existing rows, records an audit entry, and regenerates the archive', async () => {
    ...
    (executeD1Batch as jest.Mock).mockResolvedValue([28, 28, 1, 1]);
