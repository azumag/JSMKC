...
describe('QualificationScheduleDiagnosticsPanel', () => {
  ...
  it('renders the same-seed circle versus CDM comparison evidence for 7..12 players', () => {
    ...
    expect(comparison).toHaveTextContent('Day changes: 9 pairs / 7 players · total shift 22 days · max shift 5 days');
    ...
    expect(comparison).toHaveTextContent('Day changes: 47 pairs / 12 players · total shift 174 days · max shift 8 days');
