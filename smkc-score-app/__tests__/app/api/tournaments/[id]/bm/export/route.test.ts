...
describe('BM Export API Route - /api/tournaments/[id]/bm/export', () => {
  ...
  describe('GET - Export BM tournament data as CSV', () => {
    ...
    it('should return 404 when tournament is not found', async () => {
      ...
      expect(_result.data).toEqual({ success: false, error: 'Tournament not found', code: 'NOT_FOUND' });
    ...
    it('should return 500 when database query fails', async () => {
      ...
      expect(_result.data).toEqual({ success: false, error: 'Failed to export tournament', code: 'INTERNAL_ERROR' });
