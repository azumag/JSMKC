-- #3036: Finals/playoff slots are genuinely empty until their upstream match
-- resolves. SQLite/D1 cannot drop NOT NULL in place, so rebuild each shared
-- match table while preserving every column, FK, unique constraint and index.
...
SELECT `id`, `tournamentId`, `matchNumber`, `stage`, `round`, `tvNumber`, `roundNumber`, `isBye`, `player1Id`, `player1Side`, `player2Id`, `player2Side`, `score1`, `score2`, `completed`, `assignedCourses`, `rounds`, `startingCourseNumber`, `bracket`, `bracketPosition`, `losses`, `isGrandFinal`, `player1ReportedScore1`, `player1ReportedScore2`, `player2ReportedScore1`, `player2ReportedScore2`, `slotOverrideBy`, `slotOverrideAt`, `deletedAt`, `version`, `createdAt`, `updatedAt` FROM `BMMatch`;
DROP TABLE `BMMatch`;
...
SELECT `id`, `tournamentId`, `matchNumber`, `stage`, `round`, `tvNumber`, `roundNumber`, `isBye`, `player1Id`, `player1Side`, `player2Id`, `player2Side`, `score1`, `score2`, `completed`, `scoresConfirmed`, `assignedCourses`, `rounds`, `bracket`, `bracketPosition`, `losses`, `isGrandFinal`, `player1ReportedPoints1`, `player1ReportedPoints2`, `player1ReportedRaces`, `player2ReportedPoints1`, `player2ReportedPoints2`, `player2ReportedRaces`, `slotOverrideBy`, `slotOverrideAt`, `deletedAt`, `version`, `createdAt`, `updatedAt` FROM `MRMatch`;
DROP TABLE `MRMatch`;
...
SELECT `id`, `tournamentId`, `matchNumber`, `stage`, `round`, `cup`, `tvNumber`, `roundNumber`, `isBye`, `player1Id`, `player1Side`, `player2Id`, `player2Side`, `points1`, `points2`, `completed`, `suddenDeathWinnerId`, `races`, `assignedCups`, `cupResults`, `player1ReportedPoints1`, `player1ReportedPoints2`, `player1ReportedRaces`, `player2ReportedPoints1`, `player2ReportedPoints2`, `player2ReportedRaces`, `slotOverrideBy`, `slotOverrideAt`, `deletedAt`, `version`, `createdAt`, `updatedAt` FROM `GPMatch`;
DROP TABLE `GPMatch`;
