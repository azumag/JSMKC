...
jest.mock('@/lib/prisma', () => ({
  default: {
    bMQualification: { findMany: jest.fn(), deleteMany: jest.fn(), updateMany: jest.fn(), create: jest.fn() },
    bMMatch: { findMany: jest.fn(), findUnique: jest.fn(), update: jest.fn(), deleteMany: jest.fn(), create: jest.fn() },
