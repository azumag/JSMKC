...
### TC-2996: トーナメント再オープン — completed→active の復帰とステータス遷移ガード
...
- **スクリプト**: smkc-score-app/e2e/tc-all.js (TC-2996)。ユニット: smkc-score-app/__tests__/app/api/tournaments/[id]/route.test.ts（reopen / no-op / 降格許可 / draft→completed 拒否 / 未知値 400 / 不在 404）
