...
- **手順**:
  ...
  7. 管理者スコア入力ダイアログを開き、FT2 は2カップ欄、FT3 は3カップ欄が最初から表示され、その自動表示分に削除ボタンがないことを確認
  8. クリーンアップ
...
- **手順**:
  1. `PUT /api/tournaments/[id]/broadcast` で `layout.player1Name/player1Score/player2Name/player2Score/footer` の x/y 座標を設定する
